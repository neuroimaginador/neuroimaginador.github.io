...
# }
# pkg_data <- get_releases(get_pkgs("neuroimaginador")) %>%
#   mutate(
#     type = "pkg",
...
- [fcaR](https://github.com/neuroimaginador/fcaR): Herramientas para realizar análisis formal de conceptos (Formal Concept Analysis), trabajar con contextos formales, retículos de conceptos e implicaciones.
